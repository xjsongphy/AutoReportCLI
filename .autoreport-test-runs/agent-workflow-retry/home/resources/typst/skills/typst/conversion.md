...
- **Plotting ecosystem**: LaTeX has mature PGF/TikZ. Typst's `cetz` is catching up but narrower; consult the Typst package documentation when selecting alternatives.

...
use autoreport_codex_protocol::error::CodexErrorDetails;
use autoreport_codex_protocol::error::RetryLimitReachedError;
use autoreport_codex_protocol::error::UnexpectedResponseError;
use autoreport_codex_protocol::error::UsageLimitReachedError;
use http::HeaderMap;

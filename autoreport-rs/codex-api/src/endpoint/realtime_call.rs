...
use autoreport_codex_client::HttpTransport;
use autoreport_codex_client::Request;
use autoreport_codex_client::RequestBody;
use autoreport_codex_client::RequestTelemetry;
use bytes::Bytes;
use http::HeaderMap;
...
mod tests {
    ...
    use autoreport_codex_client::Request;
    use autoreport_codex_client::Response;

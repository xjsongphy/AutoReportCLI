...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "autoreport_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_icmp_connect_v6",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_icmp_assign_v4",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_icmp_assign_v6",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_dns_853_v4",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_dns_853_v6",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_smb_445_v4",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_smb_445_v6",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_smb_139_v4",
    ...
    FilterSpec {
        ...
        name: "autoreport_wfp_smb_139_v6",

...
const SETUP_BIN: &str = "autoreport-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "autoreport-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so AutoReport binaries that link the

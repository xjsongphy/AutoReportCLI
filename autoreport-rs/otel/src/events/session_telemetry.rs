...
use autoreport_codex_api::AgentIdentityTelemetry;
use autoreport_codex_api::ApiError;
use autoreport_codex_api::ResponseEvent;
...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub autoreport_codex_api_key_env_present: bool,
    pub autoreport_codex_api_key_env_enabled: bool,
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            ...
            common: {
                ...
                auth.env_autoreport_codex_api_key_present = self.metadata.auth_env.autoreport_codex_api_key_env_present,
                auth.env_autoreport_codex_api_key_enabled = self.metadata.auth_env.autoreport_codex_api_key_env_enabled,

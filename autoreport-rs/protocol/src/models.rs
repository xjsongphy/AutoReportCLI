...
//! Only `crate::NetworkAccess` is rewritten to our module path.
...
use crate::protocol_types::NetworkAccess;
use crate::protocol_types::SandboxPolicy;
        ...
        match self {
            ...
            Self::External { network } => Ok(SandboxPolicy::ExternalSandbox {
                network_access: if network.is_enabled() {
                    crate::protocol_types::NetworkAccess::Enabled
                } else {
                    crate::protocol_types::NetworkAccess::Restricted
                },
            }),
        }
    }

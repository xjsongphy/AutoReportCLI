//! Helpers for truncating tool and exec output using [`TruncationPolicy`](autoreport_codex_protocol::protocol::TruncationPolicy).

use autoreport_codex_protocol::models::FunctionCallOutputContentItem;
pub use autoreport_utils_string::approx_bytes_for_tokens;
pub use autoreport_utils_string::approx_token_count;
pub use autoreport_utils_string::approx_tokens_from_byte_count;
use autoreport_utils_string::truncate_middle_chars;
use autoreport_utils_string::truncate_middle_with_token_budget;

pub use autoreport_codex_protocol::protocol::TruncationPolicy;

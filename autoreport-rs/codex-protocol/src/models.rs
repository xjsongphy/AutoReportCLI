...
use autoreport_utils_image::PromptImageMode;
use autoreport_utils_image::data_url_from_bytes;
use autoreport_utils_image::load_for_prompt_bytes;
...
use autoreport_utils_image::ImageProcessingError;
        ...
        for i in 0..200 {
            exec_policy
                .add_prefix_rule(
                    ...
                    autoreport_execpolicy::Decision::Allow,
                )
                .expect("add rule");
        }

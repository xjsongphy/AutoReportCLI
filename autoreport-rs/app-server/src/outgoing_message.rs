...
use crate::analytics::AnalyticsEventsClient;
use autoreport_app_server_protocol::ClientResponsePayload;
use autoreport_app_server_protocol::JSONRPCErrorError;
use autoreport_app_server_protocol::RequestId;
use autoreport_app_server_protocol::Result;
use autoreport_app_server_protocol::ServerNotification;
use autoreport_app_server_protocol::ServerNotificationEnvelope;
use autoreport_app_server_protocol::ServerRequest;
use autoreport_app_server_protocol::ServerRequestPayload;
use autoreport_app_server_protocol::ServerResponse;
...
pub(crate) use autoreport_app_server_transport::ConnectionId;
pub(crate) use autoreport_app_server_transport::OutgoingError;
pub(crate) use autoreport_app_server_transport::OutgoingMessage;
pub(crate) use autoreport_app_server_transport::OutgoingResponse;
pub(crate) use autoreport_app_server_transport::QueuedOutgoingMessage;
...
mod tests {
    ...
    use autoreport_app_server_protocol::AccountLoginCompletedNotification;
    use autoreport_app_server_protocol::AccountRateLimitsUpdatedNotification;
    use autoreport_app_server_protocol::AccountUpdatedNotification;
    use autoreport_app_server_protocol::ApplyPatchApprovalParams;
    use autoreport_app_server_protocol::AuthMode;
    use autoreport_app_server_protocol::CommandExecutionApprovalDecision;
    use autoreport_app_server_protocol::CommandExecutionRequestApprovalParams;
    use autoreport_app_server_protocol::ConfigWarningNotification;
    use autoreport_app_server_protocol::DynamicToolCallParams;
    use autoreport_app_server_protocol::FileChangeRequestApprovalParams;
    use autoreport_app_server_protocol::GuardianWarningNotification;
    use autoreport_app_server_protocol::ModelRerouteReason;
    use autoreport_app_server_protocol::ModelReroutedNotification;
    use autoreport_app_server_protocol::ModelVerification;
    use autoreport_app_server_protocol::ModelVerificationNotification;
    use autoreport_app_server_protocol::RateLimitSnapshot;
    use autoreport_app_server_protocol::RateLimitWindow;
    use autoreport_app_server_protocol::ServerResponse;
    use autoreport_app_server_protocol::ToolRequestUserInputParams;
    use autoreport_app_server_protocol::TurnModerationMetadataNotification;
    use autoreport_codex_protocol::ThreadId;
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, crate::analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    autoreport_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
    ...
    async fn pending_requests_for_thread_returns_thread_requests_in_request_id_order() {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            crate::analytics::AnalyticsEventsClient::disabled(),
        ));

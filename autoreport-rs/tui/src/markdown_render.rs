    ...
    I: Iterator<Item = Event<'a>>,
{
    ...
    fn handle_event(&mut self, event: Event<'a>) {
        ...
        match event {
            ...
            // pulldown-cmark 0.12 adds math events; render as plain text.
...
// codex's snapshot test suite (`markdown_render_tests.rs`) is intentionally not
// vendored: it depends on insta/pretty_assertions/itertools/tempfile and .snap
// fixtures. The renderer is covered by `tests/codex_render.rs` instead.

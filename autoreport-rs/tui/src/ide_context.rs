...
//!
//! Vendored verbatim from `codex-rs/tui/src/ide_context.rs` so our `/ide`
//! command speaks the same private IPC protocol as the Codex VS Code / Cursor
//! extension and renders the same prompt prefix.
...
pub(crate) use prompt::apply_ide_context_to_text;

...
//!
//! This is the Codex implementation. Callers choose an explicit reduced-motion
//! fallback instead of reaching directly for time-varying spinner or shimmer
//! helpers.
...
mod tests {
    ...
    fn animation_primitives_are_only_used_by_motion_module() {
        ...
        // Codex uses `codex_utils_cargo_bin::find_resource!`; we resolve the crate
        // source dir from the compile-time manifest dir instead.

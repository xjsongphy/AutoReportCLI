#[cfg(target_os = "linux")]
use super::bwrap::WSL1_BWRAP_WARNING;
#[cfg(target_os = "linux")]
use super::bwrap::is_wsl1;
use super::landlock::AUTOREPORT_LINUX_SANDBOX_ARG0;
use super::landlock::allow_network_for_proxy;
use super::landlock::create_linux_sandbox_command_args_for_permission_profile;
use super::policy_transforms::effective_permission_profile;
use super::policy_transforms::should_require_platform_sandbox;
#[cfg(target_os = "windows")]
use super::resolve_windows_elevated_filesystem_overrides;
#[cfg(target_os = "windows")]
use super::resolve_windows_restricted_token_filesystem_overrides;
#[cfg(target_os = "windows")]
use super::windows_sandbox_uses_elevated_backend;
use crate::network_proxy::ManagedNetworkSandboxContext;
use crate::network_proxy::NetworkProxy;
use autoreport_protocol::config_types::WindowsSandboxLevel;
use autoreport_protocol::models::AdditionalPermissionProfile;
...
pub struct SandboxTransformRequest<'a> {
    ...
    pub autoreport_linux_sandbox_exe: Option<&'a Path>,
...
pub struct SandboxDirectSpawnTransformRequest<'a> {
    ...
    pub windows_sandbox_proxy_settings_mode:
        crate::windows_sandbox::WindowsSandboxProxySettingsMode,
}
    ...
    pub fn transform(
        ...
        let (argv, arg0_override, pending_sandboxed_request) = match sandbox {
            ...
            SandboxType::LinuxSeccomp => {
                let pending = pending_sandboxed_request?;
                let exe = autoreport_linux_sandbox_exe

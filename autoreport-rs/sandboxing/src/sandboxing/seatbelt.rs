...
use autoreport_protocol::permissions::PROTECTED_METADATA_PATH_NAMES;
use autoreport_protocol::protocol_types::SandboxPolicy;
use autoreport_protocol::protocol_types::WritableRoot;
...
fn build_seatbelt_access_policy(
    ...
    for (index, access_root) in roots.into_iter().enumerate() {
            ...
            access_root.excluded_subpaths.into_iter().enumerate()
        {
            ...
            // protected directory itself, such as `mkdir .autoreport`.

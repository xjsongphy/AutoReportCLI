...
fn wrap_windows_sandbox_exec_request_for_direct_spawn(
    ...
    codex_home: &Path,
    proxy_settings_mode: autoreport_windows_sandbox::WindowsSandboxProxySettingsMode,
    ...
    let helper = autoreport_windows_sandbox::resolve_exe_for_launch(source.as_path(), codex_home);

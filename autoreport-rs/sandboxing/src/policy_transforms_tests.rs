...
use autoreport_codex_protocol::models::AdditionalPermissionProfile as PermissionProfile;
use autoreport_codex_protocol::models::FileSystemPermissions;
use autoreport_codex_protocol::models::NetworkPermissions;

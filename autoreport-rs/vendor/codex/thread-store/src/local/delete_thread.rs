...
use autoreport_codex_rollout::RolloutReferenceIndex;
use autoreport_codex_rollout::SESSIONS_SUBDIR;
use autoreport_codex_rollout::find_archived_thread_path_by_id_str;
use autoreport_codex_rollout::find_thread_path_by_id_str;
use autoreport_codex_rollout::remove_thread_name_entries;
...
fn referenced_thread_error(thread_id: autoreport_codex_protocol::ThreadId) -> ThreadStoreError {
...
fn delete_rollout_file(
    ...
    let plain_path = autoreport_codex_rollout::plain_rollout_path(rollout_path);

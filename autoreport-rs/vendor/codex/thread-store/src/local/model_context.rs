...
use autoreport_codex_rollout::ModelContextScan;
use autoreport_codex_rollout::ModelContextScanProgress;
use autoreport_codex_rollout::ReverseJsonlScanner;
use autoreport_codex_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = autoreport_codex_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(

...
pub use autoreport_codex_protocol::protocol::GitSha;
use autoreport_codex_protocol::protocol::ReviewDecision;
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [autoreport_codex_protocol::protocol::PatchApplyBeginEvent]
    /// and [autoreport_codex_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [autoreport_codex_protocol::protocol::ExecCommandBeginEvent]
    /// and [autoreport_codex_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,

...
use autoreport_codex_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use autoreport_codex_protocol::config_types::MultiAgentMode;
use autoreport_codex_protocol::items::AgentMessageContent;
use autoreport_codex_protocol::items::AgentMessageItem;
use autoreport_codex_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use autoreport_codex_protocol::items::CollabAgentToolCallItem;
use autoreport_codex_protocol::items::CollabAgentToolCallStatus as CoreCollabAgentToolCallStatus;
use autoreport_codex_protocol::items::CommandExecutionItem;
use autoreport_codex_protocol::items::CommandExecutionStatus as CoreCommandExecutionStatus;
use autoreport_codex_protocol::items::DynamicToolCallItem;
use autoreport_codex_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
use autoreport_codex_protocol::items::FileChangeItem;
use autoreport_codex_protocol::items::ImageViewItem;
use autoreport_codex_protocol::items::McpToolCallItem;
use autoreport_codex_protocol::items::McpToolCallStatus as CoreMcpToolCallStatus;
use autoreport_codex_protocol::items::ReasoningItem;
use autoreport_codex_protocol::items::SubAgentActivityItem;
use autoreport_codex_protocol::items::TurnItem;
use autoreport_codex_protocol::items::UserMessageItem;
use autoreport_codex_protocol::items::WebSearchItem as CoreWebSearchItem;
use autoreport_codex_protocol::mcp::CallToolResult;
use autoreport_codex_protocol::mcp::McpServerInfo;
use autoreport_codex_protocol::memory_citation::MemoryCitation as CoreMemoryCitation;
use autoreport_codex_protocol::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
use autoreport_codex_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use autoreport_codex_protocol::models::BUILT_IN_PERMISSION_PROFILE_WORKSPACE;
use autoreport_codex_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
use autoreport_codex_protocol::models::ImageDetail;
use autoreport_codex_protocol::models::MessagePhase;
use autoreport_codex_protocol::models::NetworkPermissions as CoreNetworkPermissions;
use autoreport_codex_protocol::models::WebSearchAction as CoreWebSearchAction;
use autoreport_codex_protocol::permissions::FileSystemAccessMode as CoreFileSystemAccessMode;
use autoreport_codex_protocol::permissions::FileSystemPath as CoreFileSystemPath;
use autoreport_codex_protocol::permissions::FileSystemSandboxEntry as CoreFileSystemSandboxEntry;
use autoreport_codex_protocol::permissions::FileSystemSpecialPath as CoreFileSystemSpecialPath;
use autoreport_codex_protocol::protocol::AgentStatus as CoreAgentStatus;
use autoreport_codex_protocol::protocol::AskForApproval as CoreAskForApproval;
use autoreport_codex_protocol::protocol::ConversationTextRole;
use autoreport_codex_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use autoreport_codex_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use autoreport_codex_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use autoreport_codex_protocol::protocol::SubAgentActivityKind as CoreSubAgentActivityKind;
use autoreport_codex_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use autoreport_codex_protocol::user_input::UserInput as CoreUserInput;
...
fn thread_sources_round_trip_as_scalar_labels() {
    for (source, label) in [
        ...
        let core_source: autoreport_codex_protocol::protocol::ThreadSource = source.clone().into();
...
fn sandbox_policy_round_trips_read_only_network_access() {
    ...
    assert_eq!(
        core_policy,
        autoreport_codex_protocol::protocol::SandboxPolicy::ReadOnly {
            network_access: true,
        }
    );
...
fn core_turn_item_into_thread_item_converts_supported_variants() {
    ...
    let dynamic_tool_call_item = TurnItem::DynamicToolCall(DynamicToolCallItem {
        ...
        content_items: Some(vec![
            autoreport_codex_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText {
                text: "ok".to_string(),
            },
    ...
    let sender_thread_id = autoreport_codex_protocol::ThreadId::default();
    let receiver_thread_id = autoreport_codex_protocol::ThreadId::default();
    ...
    let sub_agent_activity_item = TurnItem::SubAgentActivity(SubAgentActivityItem {
        ...
        agent_path: autoreport_codex_protocol::AgentPath::root()
            .join("worker")
            .expect("worker path"),
    });
    ...
    assert_eq!(
        ThreadItem::from(TurnItem::Extension(
            autoreport_extension_items::ExtensionItem::WebSearch(expected_search_item.clone()),
        )),
    ...
    let file_change_item = TurnItem::FileChange(FileChangeItem {
        ...
        .into_iter()
        .collect(),
        status: Some(autoreport_codex_protocol::protocol::PatchApplyStatus::Completed),
        auto_approved: None,
...
fn turn_start_params_round_trip_multi_agent_mode() {
    ...
    assert_eq!(
        ...
        Some(autoreport_codex_protocol::config_types::MultiAgentMode::Proactive)
    );
    assert_eq!(
...
fn thread_settings_update_params_preserve_field_level_experimental_gates() {
    ...
    let collaboration_mode = ThreadSettingsUpdateParams {
        thread_id: "thread_123".to_string(),
        collaboration_mode: Some(autoreport_codex_protocol::config_types::CollaborationMode {
            mode: autoreport_codex_protocol::config_types::ModeKind::Plan,

...
use autoreport_codex_protocol::protocol::HookEventName as CoreHookEventName;
use autoreport_codex_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use autoreport_codex_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use autoreport_codex_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use autoreport_codex_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use autoreport_codex_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use autoreport_codex_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use autoreport_codex_protocol::protocol::HookScope as CoreHookScope;
use autoreport_codex_protocol::protocol::HookSource as CoreHookSource;
use autoreport_codex_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;

...
use autoreport_codex_protocol::items::McpToolCallError as CoreMcpToolCallError;
use autoreport_codex_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use autoreport_codex_protocol::mcp::McpServerInfo;
use autoreport_codex_protocol::mcp::Resource as McpResource;
pub use autoreport_codex_protocol::mcp::ResourceContent as McpResourceContent;
use autoreport_codex_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use autoreport_codex_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from autoreport_codex_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from autoreport_codex_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> autoreport_codex_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => autoreport_codex_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => autoreport_codex_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => autoreport_codex_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}

...
use autoreport_codex_protocol::protocol::MultiAgentVersion;
use autoreport_codex_protocol::protocol::ResumedHistory;
use autoreport_codex_protocol::protocol::RolloutItem;
use autoreport_codex_protocol::protocol::RolloutLine;
use autoreport_codex_protocol::protocol::SessionContextWindow;
...
impl From<autoreport_state::ThreadsPage> for ThreadsPage {
    fn from(db_page: autoreport_state::ThreadsPage) -> Self {
        let autoreport_state::ThreadsPage {
            items,
            parent_thread_ids,
            next_anchor,
            num_scanned_rows,
...
fn thread_item_from_state_metadata(
    item: autoreport_state::ThreadMetadata,
    parent_thread_id: Option<ThreadId>,
) -> ThreadItem {
    ThreadItem {
...
async fn select_resume_path_from_db_page(
    page: &autoreport_state::ThreadsPage,
    filter_cwd: Option<&Path>,
    default_provider: &str,
) -> Option<PathBuf> {
    match filter_cwd {

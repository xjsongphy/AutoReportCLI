...
use autoreport_state::BackfillState;
use autoreport_state::BackfillStats;
use autoreport_state::BackfillStatus;
use autoreport_state::DB_ERROR_METRIC;
use autoreport_state::DB_METRIC_BACKFILL;
use autoreport_state::DB_METRIC_BACKFILL_DURATION_MS;
use autoreport_state::ExtractionOutcome;
use autoreport_state::ThreadMetadataBuilder;
use autoreport_state::apply_rollout_item;
use chrono::DateTime;
...
pub(crate) async fn backfill_sessions_with_lease(
    ...
    let metric_client = autoreport_otel::global();

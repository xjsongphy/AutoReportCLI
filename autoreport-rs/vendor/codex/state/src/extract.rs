...
mod tests {
    ...
    use autoreport_codex_protocol::config_types::Settings;
    use autoreport_codex_protocol::items::TurnItem;
    ...
    use autoreport_codex_protocol::protocol::ThreadGoal;
    use autoreport_codex_protocol::protocol::ThreadGoalStatus;
    use autoreport_codex_protocol::protocol::ThreadGoalUpdatedEvent;
    use autoreport_codex_protocol::protocol::ThreadHistoryMode;
    use autoreport_codex_protocol::protocol::ThreadSettingsAppliedEvent;
    use autoreport_codex_protocol::protocol::ThreadSettingsSnapshot;
    use autoreport_codex_protocol::protocol::TurnContextItem;
    ...
    fn turn_context_does_not_override_session_cwd() {
        ...
        apply_rollout_item(
            ...
            &RolloutItem::TurnContext(TurnContextItem {
                ...
                effort: None,
                summary: autoreport_codex_protocol::config_types::ReasoningSummary::Auto,
            }),
            "test-provider",
        );

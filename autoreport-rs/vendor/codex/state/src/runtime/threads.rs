...
ON CONFLICT(id) DO NOTHING
        ...
        .bind(
            metadata
                .thread_source
                .as_ref()
                .map(autoreport_codex_protocol::protocol::ThreadSource::as_str),
        )
    ...
    async fn apply_rollout_items_uses_override_updated_at_when_provided() {
        ...
        let items = vec![RolloutItem::EventMsg(EventMsg::TokenCount(
            autoreport_codex_protocol::protocol::TokenCountEvent {
                info: Some(autoreport_codex_protocol::protocol::TokenUsageInfo {
                    total_token_usage: autoreport_codex_protocol::protocol::TokenUsage {
                        input_tokens: 0,
                    ...
                    last_token_usage: autoreport_codex_protocol::protocol::TokenUsage::default(),

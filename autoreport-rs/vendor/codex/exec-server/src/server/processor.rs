...
impl ConnectionProcessor {
    ...
    pub(crate) fn new(runtime_paths: ExecServerRuntimePaths) -> Self {
        Self::new_with_telemetry(
            ...
            autoreport_http_client::HttpClientFactory::new(
                autoreport_http_client::OutboundProxyPolicy::ReqwestDefault,
            ),
        )
    }
    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            JsonRpcConnectionEvent::MalformedMessage { reason } => {
                ...
                if outgoing_tx
                    .send(RpcServerOutboundMessage::Error {
                        request_id: autoreport_exec_server_protocol::RequestId::Integer(-1),
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                autoreport_exec_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                autoreport_exec_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                autoreport_exec_server_protocol::JSONRPCMessage::Response(response) => {
                ...
                autoreport_exec_server_protocol::JSONRPCMessage::Error(error) => {
...
fn request_span(
    span_name: &str,
    request: &autoreport_exec_server_protocol::JSONRPCRequest,
) -> tracing::Span {
    ...
    if let Some(trace) = &request.trace
        && !autoreport_otel::set_parent_from_w3c_trace_context(&span, trace)
    {
...
mod tests {
    ...
    use autoreport_exec_server_protocol::JSONRPCNotification;
    use autoreport_exec_server_protocol::JSONRPCRequest;
    ...
    fn request_span_uses_bounded_name_wire_method_and_inbound_trace_parent() {
        ...
        let trace = autoreport_codex_protocol::protocol::W3cTraceContext {

...
use autoreport_utils_absolute_path::canonicalize_preserving_symlinks;
        ...
        sandbox_manager
            .transform_for_direct_spawn(SandboxDirectSpawnTransformRequest {
                ...
                windows_sandbox_proxy_settings_mode:
                    autoreport_sandboxing::WindowsSandboxProxySettingsMode::Preserve,
...
mod tests {
    ...
    fn sandbox_context_with_cwd(
        ...
        autoreport_file_system::FileSystemSandboxContext::from_permission_profile_with_cwd(

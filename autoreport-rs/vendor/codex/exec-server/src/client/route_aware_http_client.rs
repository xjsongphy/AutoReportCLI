...
use autoreport_http_client::RouteAwareRequestError;
...
pub(crate) struct PendingRouteAwareHttpBodyStream {
    ...
    pub(crate) response: autoreport_http_client::HttpResponse,
}
...
impl RouteAwareHttpRequestRunner {
    ...
    ) -> Result<(HttpRequestResponse, Option<PendingRouteAwareHttpBodyStream>), JSONRPCErrorError>
    {
        ...
        autoreport_otel::inject_span_w3c_trace_headers(&request_span, &mut headers);

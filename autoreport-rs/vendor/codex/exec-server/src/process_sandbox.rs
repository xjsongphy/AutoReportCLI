...
use autoreport_network_proxy::NetworkPolicyDecider;
use autoreport_network_proxy::NetworkProxy;
use autoreport_network_proxy::NetworkProxyHandle;
use autoreport_network_proxy::NetworkProxyState;
...
use autoreport_sandboxing::SandboxTransformRequest;
use autoreport_sandboxing::SandboxType;
use autoreport_sandboxing::SandboxablePreference;
use autoreport_sandboxing::WindowsSandboxFilesystemOverrides;
use autoreport_sandboxing::WindowsSandboxProxySettingsMode;
use autoreport_sandboxing::WindowsSandboxSpawnRequest;
use autoreport_sandboxing::resolve_windows_elevated_filesystem_overrides;
use autoreport_sandboxing::resolve_windows_restricted_token_filesystem_overrides;
use autoreport_sandboxing::windows_sandbox_uses_elevated_backend;
use autoreport_sandboxing::with_managed_mitm_ca_readable_root;
...
struct PreparedWindowsSandboxRequest {
    ...
    windows_sandbox_level: autoreport_codex_protocol::config_types::WindowsSandboxLevel,
    proxy_enforced: bool,

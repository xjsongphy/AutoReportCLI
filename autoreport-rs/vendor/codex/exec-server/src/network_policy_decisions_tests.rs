...
use autoreport_network_proxy::NetworkDecision;
use autoreport_network_proxy::NetworkPolicyRequest;
use autoreport_network_proxy::NetworkPolicyRequestArgs;
use autoreport_network_proxy::NetworkProtocol;
...
impl DeciderHarness {
    ...
    async fn next_request(
        ...
        autoreport_exec_server_protocol::RequestId,

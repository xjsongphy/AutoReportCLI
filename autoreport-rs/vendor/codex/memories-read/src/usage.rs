...
use autoreport_shell_command::bash::parse_shell_script_into_commands;
use autoreport_shell_command::is_safe_command::is_known_safe_command;
use autoreport_shell_command::parse_command::parse_shell_script;

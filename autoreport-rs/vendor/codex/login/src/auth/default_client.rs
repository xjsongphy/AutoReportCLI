...
use autoreport_http_client::HttpClientBuilder;
use autoreport_http_client::HttpClientFactory;
use autoreport_http_client::OutboundProxyPolicy;
pub use autoreport_http_client::RequestBuilder as CodexRequestBuilder;
use autoreport_terminal_detection::user_agent;
use http::HeaderMap;
...
pub use autoreport_config::ResidencyRequirement;

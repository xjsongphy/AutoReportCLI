...
use autoreport_codex_protocol::protocol::HookCompletedEvent;
use autoreport_codex_protocol::protocol::HookEventName;
use autoreport_codex_protocol::protocol::HookExecutionMode;
...
use autoreport_codex_protocol::protocol::HookScope;
...
pub(crate) fn completed_summary(
    ...
    entries: Vec<autoreport_codex_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(
    ...
    match source {
        ...
        autoreport_codex_protocol::protocol::HookSource::Project => "project",
        autoreport_codex_protocol::protocol::HookSource::Mdm => "mdm",

...
fn append_matcher_groups(
    ...
    display_order: &mut i64,
    source: &HookHandlerSource<'_>,
    event_name: autoreport_codex_protocol::protocol::HookEventName,
            ...
            match handler {
                HookHandlerConfig::Command {
                    ...
                    let additional_context_limit = if matches!(
                        event_name,
                        autoreport_codex_protocol::protocol::HookEventName::PreToolUse
                            | autoreport_codex_protocol::protocol::HookEventName::PostToolUse
                            | autoreport_codex_protocol::protocol::HookEventName::SessionStart
                            | autoreport_codex_protocol::protocol::HookEventName::UserPromptSubmit
                            | autoreport_codex_protocol::protocol::HookEventName::SubagentStart
                    ) {
                        additional_context_limit
                    } else {
...
fn normalize_command_hook(
    ...
    if event_name != autoreport_codex_protocol::protocol::HookEventName::SessionEnd {

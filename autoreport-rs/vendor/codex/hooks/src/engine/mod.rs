...
pub(crate) struct ConfiguredHandler {
    pub event_name: autoreport_codex_protocol::protocol::HookEventName,
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<autoreport_codex_protocol::items::HookPromptFragment>,
    ) -> Vec<autoreport_codex_protocol::items::HookPromptFragment> {
        self.output_spiller

...
use autoreport_codex_protocol::error::Result as CoreResult;
use autoreport_codex_protocol::openai_models::ModelInfo;
use autoreport_codex_protocol::openai_models::ModelPreset;
...
impl OpenAiModelsManager {
    ...
    async fn try_load_cache(&self) -> bool {
        ...
        let _timer =
            autoreport_otel::start_global_timer("codex.remote_models.load_cache.duration_ms", &[]);
        let client_version = crate::client_version_to_whole();

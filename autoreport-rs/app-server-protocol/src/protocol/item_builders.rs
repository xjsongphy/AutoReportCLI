...
use autoreport_codex_protocol::protocol::GuardianAssessmentAction;
...
use autoreport_codex_protocol::protocol::ReviewOutputEvent;
use autoreport_codex_protocol::review_format::REVIEW_FALLBACK_MESSAGE;
use autoreport_codex_protocol::review_format::render_review_output_text;
use autoreport_shell_command::parse_command::parse_command;
...
pub fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            autoreport_codex_protocol::protocol::GuardianAssessmentStatus::InProgress => {
                GuardianApprovalReviewStatus::InProgress
            }
            autoreport_codex_protocol::protocol::GuardianAssessmentStatus::Approved => {
                GuardianApprovalReviewStatus::Approved
            }
            autoreport_codex_protocol::protocol::GuardianAssessmentStatus::Denied => {
                GuardianApprovalReviewStatus::Denied
            }
            autoreport_codex_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                GuardianApprovalReviewStatus::TimedOut
            }
            autoreport_codex_protocol::protocol::GuardianAssessmentStatus::Aborted => {

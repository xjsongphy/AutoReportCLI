    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                autoreport_codex_protocol::protocol::AgentStatus::Errored(_)
...
mod tests {
    ...
    use autoreport_codex_protocol::protocol::CollabResumeBeginEvent;
    use autoreport_codex_protocol::protocol::CollabResumeEndEvent;
    use autoreport_codex_protocol::protocol::ExecCommandOutputDeltaEvent;
    use autoreport_codex_protocol::protocol::ExecOutputStream;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: autoreport_codex_protocol::protocol::AgentStatus::NotFound,
        };

...
mod tests {
    ...
    use autoreport_codex_protocol::models::BUILT_IN_PERMISSION_PROFILE_READ_ONLY;
    use autoreport_codex_protocol::parse_command::ParsedCommand;
    use autoreport_codex_protocol::protocol::CodexResponseHandoffMode;
    use autoreport_codex_protocol::protocol::ConversationTextRole;
    use autoreport_codex_protocol::protocol::RealtimeConversationVersion;
    use autoreport_codex_protocol::protocol::RealtimeOutputModality;
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(autoreport_codex_protocol::protocol::W3cTraceContext {
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    autoreport_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],

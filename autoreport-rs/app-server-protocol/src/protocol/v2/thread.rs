...
use autoreport_codex_protocol::config_types::Personality;
use autoreport_codex_protocol::config_types::ReasoningSummary;
pub use autoreport_codex_protocol::dynamic_tools::DynamicToolFunctionSpec;
pub use autoreport_codex_protocol::dynamic_tools::DynamicToolNamespaceSpec;
pub use autoreport_codex_protocol::dynamic_tools::DynamicToolNamespaceTool;
pub use autoreport_codex_protocol::dynamic_tools::DynamicToolSpec;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "autoreport_codex_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
...
impl From<autoreport_codex_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: autoreport_codex_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> autoreport_codex_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => autoreport_codex_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => autoreport_codex_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `autoreport_codex_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}

...
use autoreport_codex_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use autoreport_codex_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use autoreport_codex_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use autoreport_codex_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
...
pub(crate) fn web_search_action_from_core(
    value: autoreport_codex_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        autoreport_codex_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        autoreport_codex_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        autoreport_codex_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        autoreport_codex_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<autoreport_codex_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: autoreport_codex_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for autoreport_codex_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{

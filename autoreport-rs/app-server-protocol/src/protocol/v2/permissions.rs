...
use autoreport_codex_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use autoreport_codex_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use autoreport_codex_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use autoreport_codex_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use autoreport_codex_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use autoreport_codex_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use autoreport_codex_protocol::models::LegacyReadWriteRoots;
...
use autoreport_codex_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
...
use autoreport_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> autoreport_codex_protocol::protocol::SandboxPolicy {
        match self {
            SandboxPolicy::DangerFullAccess => {
                autoreport_codex_protocol::protocol::SandboxPolicy::DangerFullAccess
            }
...
impl From<autoreport_codex_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: autoreport_codex_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            autoreport_codex_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }

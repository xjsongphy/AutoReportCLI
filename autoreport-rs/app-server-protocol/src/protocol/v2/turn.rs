...
use autoreport_codex_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use autoreport_codex_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use autoreport_codex_protocol::user_input::ByteRange as CoreByteRange;
use autoreport_codex_protocol::user_input::TextElement as CoreTextElement;

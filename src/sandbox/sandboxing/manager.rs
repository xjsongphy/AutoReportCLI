...
use super::landlock::CODEX_LINUX_SANDBOX_ARG0;
...
impl SandboxManager {
    ...
    pub fn transform_for_direct_spawn(
        ...
        #[cfg(target_os = "windows")]
        {
            let codex_home = crate::sandbox::home_dir::find_codex_home()
...
fn wrap_windows_sandbox_exec_request_for_direct_spawn(
    ...
    codex_home: &Path,
    proxy_settings_mode: crate::sandbox::windows_sandbox::WindowsSandboxProxySettingsMode,
    ...
    *program = helper.to_string_lossy().into_owned();
    ...
    let mut wrapper_args =
        crate::sandbox::windows_sandbox::create_windows_sandbox_command_args_for_permission_profile(
            inner_command,
            &native_cwd,
            workspace_roots,
            &request.env,
